...
const ProductCard = ({ product }) => {
	...
	return (
		<section data-aos="fade-up">
			<div className="max-w-lg rounded-sm shadow-sm dark:bg-gray-900 dark:text-gray-100 transition-all duration-700 ease-in-out hover:shadow-lg  relative group  hover:scale-105">
				<div className="geeks">
					<img
						src={image}
						alt=""
